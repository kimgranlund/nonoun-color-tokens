...
ok(/README\.md/.test(zipText) && /plugin marketplace add kimgranlund\/ultimate-tokens/.test(zipText) && /plugin install ultimate-tokens/.test(zipText), "(ee) the zip root README carries the consumption-plugin install commands");
...
ok(app.querySelectorAll(".tyi-voice").length === 11 && !app.querySelector(".tyi-voice-edit"), `(tyv) the Scale tab lists the 11 voices, none expanded by default (got ${app.querySelectorAll(".tyi-voice").length})`);
