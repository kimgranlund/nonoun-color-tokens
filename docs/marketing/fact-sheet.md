...
| Export formats | CSS custom properties (HEX or OKLCH) · Tailwind v4 · shadcn/ui · DTCG · JSON · Figma variables · Figma UI3 (Material) · Design System export (`tokens.json` + `DESIGN.md`, three AI-design-tool targets) · re-importable Config · Download-all `.zip` | `src/engine/exports.js` (Design System export: `src/engine/ds-export.js`) |
