...
| Type voices | **11** — Display · Heading · Sub-heading · Kicker · Lead · Body · Quote · Caption · UI · Code · Legal (Lead/Quote/Caption/Legal are the editorial voices) | `src/engine/type.mjs` `make11` |
