...
//
// It reads a sibling `brand-kit.json` (the resolved tokens, produced by "Ultimate Tokens by NONOUN") and
// exposes the palettes, the perceptual ramps, and the resolved 59-role semantic layer (light + dark) as
...
const usageGuide = () => {
  ...
  let g = `# ${kit.name || "Brand Kit"} — usage\n\n` +
    `Generated by ${kit.generator || "Ultimate Tokens by NONOUN"}. Apply these tokens; never invent raw values.\n\n` +
