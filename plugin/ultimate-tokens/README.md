...
|---|---|---|
| **color-tokens** | the colour of any UI | the 53-role semantic layer — buttons (all variants + states), form fields, text hierarchy, cards/modals/elevation, intents/toasts/scrims, navigation, focus. Enforces the pairing law and on-colour discipline. |
